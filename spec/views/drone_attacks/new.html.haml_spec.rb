...
describe "drone_attacks/new" do
  before(:each) do
    assign(:drone_attack, stub_model(DroneAttack,
      :incident_year => 1,
      :location => "MyString",
      :province => "MyString",
      :city => "MyString",
  ...
  it "renders new drone_attack form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => drone_attacks_path, :method => "post" do
